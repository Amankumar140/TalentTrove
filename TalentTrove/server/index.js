...
//   //     io.to(message.projectId).emit('receive-message', message);
//   // });
...
//       const { projectId, senderId, text, time } = data;
  
//       // Save to database
//       const message = new MessageModel({ projectId, senderId, text, time });
//       await message.save();
  
//       console.log("Message saved:", message);
  
//       // Send message to other users in the project room
...
//   //   app.get('/fetch-chats/:id', async (req, res) => {
//   //     try {
//   //         const chats = await Chat.find({ projectId: req.params.id }).sort({ time: 1 });
//   //         res.status(200).json(chats);
//   //     } catch (err) {
//   //         res.status(500).json({ error: err.message });
//   //     }
...
//   //     const { projectId, senderId, message, time } = req.body;
  
//   //     try {
//   //         const newMessage = new Chat({ projectId, senderId, message, time });
